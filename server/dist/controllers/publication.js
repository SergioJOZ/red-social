...
const user = (req, res) => {
  ...
  Publication.find({
    user: id
  }).sort("-created_at").populate("user", "-password -__v -role -email").paginate(page, itemsPerPage, (error, publications, total) => {
...
const feed = async (req, res) => {
  ...
  try {
    ...
    }).populate("user", "-password -role -__v -email").sort("-created_at").paginate(page, itemsPerPage, (error, publications, total) => {
